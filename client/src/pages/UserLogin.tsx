...
import { Users, Lock, Mail, Eye, EyeOff, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 opacity-40">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-sky-600 to-indigo-600 animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-4">
            <div className="p-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-lg border-2 border-blue-400">
        ...
        {/* Login Form */}
        <div className="bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-blue-500/30 p-8">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? (
                    <EyeOff className="text-gray-300 hover:text-gray-100" size={20} />
                  ) : (
                    <Eye className="text-gray-300 hover:text-gray-100" size={20} />
                  )}
                </button>
              </div>
            </div>
